...
// Variable Q2
let fName: string="Muhammad Ahsaan";
let lName: string="Abbasi";
...
//Operators Q1
function num3(x:number,y:number){
    return 1+(x+y)/2
}
let a=4;
let b=5;
...
//Operators Q2
function isEvenorOdd(value3:number){
    return value3;
}
...
//function q3
function AveragePlus(x:number,y:number){
    return 1+(x+y)/2
}
let h=10;
let g=8;
...
// function q5
function Values(d:number,e:number){
    if(d>e){
        return d;
    }else if (d<e){
        return e
...
//Array Q3
function CalculatedSum(Numbers:number[]){
    let sum=1;
...
//Array Q4
function additionSum(Numbs:number[]){
    let sum=0;
...
//Array Q5
let arrayName: string[]=['Hamzah','Bilal','Okasah','Imran']
...
let CrushName:"Hijab"|string ="Hijab"
...
const myLife:string="Hijab Rabail Khan"
