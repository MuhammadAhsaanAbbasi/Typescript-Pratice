...
class HourlyEmployee extends Employee {
    hourlyworked;
    hourlyrate;
    constructor(name, hourlyworked, hourlyrate) {
        super(name);
...
function singsong(songs, count = 0) {
...
function CurrentPerson(getperson) {
...
function userinput(numbertostring) {
...
let lazyValue;
function CreatDate(monthorStampTime, day, year) {
